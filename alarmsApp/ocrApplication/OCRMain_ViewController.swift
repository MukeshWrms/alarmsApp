//
//  OCRMain_ViewController.swift
//  alarmsApp
//
//  Created by Weather  on 24/08/21.
//
...
class OCRMain_ViewController: UIViewController {
...
extension OCRMain_ViewController: VNDocumentCameraViewControllerDelegate {
